                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td>
                                        <button class='btn editar' onclick=\"window.location.href='PHP/editar_cliente.php?id=" . htmlspecialchars($row["id"]) . "'\">Editar</button>
                                        <button class='btn eliminar' onclick=\"window.location.href='PHP/eliminar_cliente_be.php?id=" . htmlspecialchars($row["id"]) . "'\">Eliminar</button>
                                    </td>
                                </tr>";
                        }
                    } else {
